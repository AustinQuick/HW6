            ...
            <InsertItemTemplate>
                <table class="table" style="text-align: center">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="tPreparation" runat="server" Text='<%# Bind("preparation")%>' />
                        </td>
                        <td>
                            <asp:RequiredFieldValidator CssClass="val" ID="valPreparation" runat="server" ErrorMessage="Please enter preparation instructions." ControlToValidate="tPreparation" Font-Bold="False" SetFocusOnError="True"></asp:RequiredFieldValidator>
